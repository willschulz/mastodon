  ...
  included do
    ...
    scope :paginate_by_max_id_fav, ->(limit, max_id = nil, since_id = nil) {
      ...
      query = joins(:status_stat)
              ...
              .reorder((Arel::Nodes::Multiplication.new(StatusStat.arel_table[:favourites_count], 100000) +
                  Arel::Nodes::NamedFunction.new('extract', [Arel::Nodes.build_quoted('epoch'), arel_table[:created_at]]).to_sql.to_i).desc) #yo this works!
              #
              #
